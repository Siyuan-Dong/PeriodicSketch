...
def main():
    ...
    for i in lis:
        ...
        plt.xlabel(r'$\alpha$',fontweight='bold',fontsize=24)#设置x轴，并设定字号大小
        ...
        plt.plot(real_data1['alpha'], real_data1[i], label=r"cmp", linestyle='-', marker="^", markersize=10, alpha = 1, linewidth=3, markeredgewidth=2)
        plt.plot(real_data2['alpha'], real_data2[i], label=r"Ours", linestyle='-', marker="v", markersize=10, alpha = 1, linewidth=3, markeredgewidth=2)
