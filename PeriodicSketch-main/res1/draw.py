...
def main():
    ...
    for i in lis:
        real_file1 = u'./'+'cmp_algo'+'.csv'
        real_data1 = pd.read_csv(real_file1)
        real_file2 = u'./'+'Ours'+'.csv'
        real_data2 = pd.read_csv(real_file2)
        real_file3 = u'./'+'Baseline'+'.csv'
        ...
        plt.plot(real_data1['mem']/1000, real_data1[i], label=r"cmp", linestyle='-', marker="^", markersize=10, alpha = 1, linewidth=3, markeredgewidth=2)
        plt.plot(real_data2['mem']/1000, real_data2[i], label=r"Ours", linestyle='-', marker="v", markersize=10, alpha = 1, linewidth=3, markeredgewidth=2)
