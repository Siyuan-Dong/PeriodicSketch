...
def main():
    ...
    for i in lis:
        ...
        plt.plot(real_data1['k'][:4], real_data1[i][:4], label=r"cmp", linestyle='-', marker="^", markersize=10, alpha = 1, linewidth=3, markeredgewidth=2)
        plt.plot(real_data2['k'][:4], real_data2[i][:4], label=r"Ours", linestyle='-', marker="v", markersize=10, alpha = 1, linewidth=3, markeredgewidth=2)
